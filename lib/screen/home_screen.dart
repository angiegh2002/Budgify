...
final baseCurrency = BASE_CURRENCY;
...
Text(
"${convertedBalance.toStringAsFixed(2)} ${currencyProvider.selectedCurrency}",
...
title: "Expenses",
amount: "${convertedExpenses.toStringAsFixed(2)} ${currencyProvider.selectedCurrency}",
...
child: buildSmallCard(
title: "Income",
amount: "${convertedIncome.toStringAsFixed(2)} ${currencyProvider.selectedCurrency}",
...
TextButton(
onPressed: () async {
double enteredBudget = double.tryParse(budgetEditController.text) ?? 0;

final currencyProvider = context.read<CurrencyProvider>();
double budgetInBaseCurrency = currencyProvider.convert(
enteredBudget,
currencyProvider.selectedCurrency,
BASE_CURRENCY,
);

await CacheHelper.prefs.setDouble("monthlyBudget", budgetInBaseCurrency);
...
SnackBar(
content: Text("Budget saved: ${enteredBudget.toStringAsFixed(2)} ${currencyProvider.selectedCurrency}"),
...
Text(
"${convertedBudget.toStringAsFixed(2)} ${currencyProvider.selectedCurrency}",
style: const TextStyle(
fontSize: 24,
fontWeight: FontWeight.bold,
),
